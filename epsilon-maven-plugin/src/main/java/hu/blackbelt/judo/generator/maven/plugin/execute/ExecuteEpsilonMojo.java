...
import hu.blackbelt.judo.generator.maven.plugin.XmlModel;
...
public class ExecuteEpsilonMojo extends AbstractEpsilonMojo {
    ...
    synchronized public void execute() throws MojoExecutionException, MojoFailureException {
	    ...
	    Map<XmlModel, PlainXmlModel> xmlModels = Maps.newConcurrentMap();
        ...
        try {
            ...
            try {
	            ...
	            addPlainXmlModels(resourceSet, projectModelRepository, xmlModels);
